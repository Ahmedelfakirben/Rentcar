      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <FadeIn delay={300} className="h-full">
            <div className="block h-full p-8 rounded-2xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-orange/50 hover:glow-orange transition-all group">
              ...
              <div className="space-y-1">
                ...
                <a href="tel:0618399606" className="block text-lg font-semibold text-foreground hover:text-orange transition-colors">06 18 39 96 06</a>
              </div>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={400} className="h-full">
            <a
              ...
              className="block h-full p-8 rounded-2xl bg-black/40 backdrop-blur-xl border border-white/10 hover:border-orange/50 hover:glow-orange transition-all group"
            >
              <div className="w-12 h-12 mx-auto rounded-full border border-orange/40 flex items-center justify-center text-orange mb-4 group-hover:bg-orange group-hover:text-background transition-all">
